...
class Test(unittest.TestCase):
    ...
    def test_ex02(self):
        ...
        # Invalid ip
        self.assertEqual(ex02("0.0.0.0", "255.0.0.0"), [result_message["IP invalid"]])
        self.assertEqual(ex02("127.0.0.0", "255.0.0.0"), [result_message["IP invalid"]])
        self.assertEqual(ex02("224.0.0.0", "255.0.0.0"), [result_message["IP invalid"]])
        self.assertEqual(ex02("240.0.0.0", "255.0.0.0"), [result_message["IP invalid"]])

        # Invalid masque
        self.assertEqual(ex02("1.0.0.0", "192.0.0.0"), [result_message["masque invalid"]])
        self.assertEqual(ex02("128.0.0.0", "255.252.0.0"), [result_message["masque invalid"]])
        self.assertEqual(ex02("192.0.0.0", "255.255.252.0"), [result_message["masque invalid"]])
